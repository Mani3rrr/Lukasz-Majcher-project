...
public class BookDirectoryTestSuite {
    ...
    public void testlistBooksInHandsOf0() {
        ...
        LibraryUser user = new LibraryUser("John", "Beck", "12345678");
        userList.add(user);
    ...
    public void testlistBooksInHandsOf1() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> bookList = new ArrayList<>();
        Book book = new Book("Lotr", "Tolkien", 2000);
        bookList.add(book);
        List<LibraryUser> userList = new ArrayList<>();
        LibraryUser user = new LibraryUser("John", "Beck", "12345678");
        userList.add(user);
    ...
    public void testlistBooksInHandsOf5() {
        ...
        List<Book> bookList = new ArrayList<>();
        Book book = new Book("Lotr", "Tolkien", 2000);
        Book book2 = new Book("Got", "R.R. Martin", 1996);
        Book book3 = new Book("Lotr2", "Tolkien", 2000);
        Book book4 = new Book("Got2", "R.R. Martin", 1996);
        Book book5 = new Book("Lotr3", "Tolkien", 2000);
        bookList.add(book);
        bookList.add(book2);
        bookList.add(book3);
        bookList.add(book4);
