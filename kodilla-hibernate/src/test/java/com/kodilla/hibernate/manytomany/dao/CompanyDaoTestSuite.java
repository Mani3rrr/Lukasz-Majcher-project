...
public class CompanyDaoTestSuite {
    ...
    public void testFindEmployee() {
        ...
        List<Employee> employees = employeeDao.findEmployee("Smith");
    ...
    public void testFindCompany() {
        //given
        Company company1 = new Company("Clinic");
        Company company2 = new Company("Gabinet");
        Company company3 = new Company("Bakery");
        ...
        Assert.assertEquals("Gabinet", companies.get(0).getName());
